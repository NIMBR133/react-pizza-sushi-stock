...
const CartTotal = ({ totalCount, totalPrice, onClickClearCart }) => {
    return (
        <div className="cart-total">
            <div>
                <div className={`cart-total__delete ${!totalCount && 'cart-total__delete_disabled'}`}
                    onClick={onClickClearCart}>
                    <svg enableBackground="new 0 0 40 40" id="Слой_1" version="1.1" viewBox="0 0 40 40">
                        <g>
